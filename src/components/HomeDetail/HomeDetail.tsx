  ...
  return (
    <Box py="64px" maxW={CONTAINER_MAX_WIDTH} m="auto">
      <Box maxW="730px">
        ...
        <Text variant="content">
          Whether your loved one needs short-term assisted living or a long-term
          care, they will enjoy the senior living community we provide. Those in
          our care enjoy community activities and social gatherings that allow
          older adults to form enriching friendships. Creating bonds through
          shared interests enables the seniors in our community to thrive.
        </Text>
        <Text variant="content" mt="20px">
          ...
          socializing than ever before while in assisted living. They will find
          their days filled with productive and enjoyable activities and may
          make firm friendships. Being part of a thriving community helps
